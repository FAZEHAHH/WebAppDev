...
<body>
    ...
    <h2 class="section-header">Section 3: Procurement Risks</h2>

    <form method="POST" action="hr.php" onsubmit="return validateProcurement();">
      ...
      <?php
         ...
         if ($result->num_rows > 0) {
             ...
             while ($row = $result->fetch_assoc()) {
                 ...
                 for ($i = 1; $i <= 5; $i++) {
                     echo "<label>" . $i . " <input type='radio' name='procurement_scale[" . $row["id"] . "]' value='" . $i . "'> </label>";
                 }
                 echo "</div>";
                 $questionNumber++;
            }
