...
<body>
    ...
    <h2 class="section-header">Section 2: Strategic Management Risks</h2>
    
    <form method="POST" action="procurement.php" onsubmit="return validateStrategicManagement();">
       ...
       <?php
        ...
        $sql = "SELECT * FROM strategic_management";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                for ($i = 1; $i <= 5; $i++) {
                    echo "<label>" . $i . " <input type='radio' name='strategic_scale[" . $row["id"] . "]' value='" . $i . "'> </label>";
                }
    ...
    <script>
        function validateStrategicManagement() {
