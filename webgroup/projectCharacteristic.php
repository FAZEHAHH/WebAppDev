...
<body>
    ...
    <h2 class="section-header">Section 1: Project Characteristics</h2>

    <form method="POST" action="strategicManagement.php" onsubmit="return validateProjectCharacteristic();">
        ...
        $sql = "SELECT * FROM project_characteristics";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                for ($i = 1; $i <= 5; $i++) {
                    echo "<label>" . $i . " <input type='radio' name='characteristic_scale[" . $row["id"] . "]' value='" . $i . "'> </label>";
                }
                echo "</div>";
                $questionNumber++;
            }
...
<script>
        function validateProjectCharacteristic() {
