...
<body>
    ...
    <h2 class="section-header">Section 6: Project Management Integration Risks</h2>

    <form method="POST" action="projectRequirement.php" onsubmit="return validateProjectManagement();">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                for ($i = 1; $i <= 5; $i++) {
                    echo "<label>" . $i . " <input type='radio' name='project_management_scale[" . $row["id"] . "]' value='" . $i . "'> </label>";
                }
                echo "</div>";
                $questionNumber++;
            }
    ...
    <script>
        function validateProjectManagement() {
